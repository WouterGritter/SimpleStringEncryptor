package me.woutergritter.stringencryptor.dummy; // TODO: Change to %PACKAGE%
...
public class Decrypt {
    ...
    public static String decrypt(String str) {
        if(!decrypted.containsKey(str)) {
            if(!isKeySet) {
                String key = DummyKeyProvider.provideKey(); // TODO: Change to %KEY_PROVIDER_CLASS%
                setKey(key);
    ...
    private static void notifyInvalidKey() {
        if(!notifiedInvalidKey) {
            ...
            DummyKeyProvider.onInvalidKey(); // TODO: Change to %KEY_PROVIDER_CLASS%
        }
    }
}
